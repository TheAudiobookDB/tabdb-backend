...
CREATE OR REPLACE FUNCTION nanoid(
    size int DEFAULT 16, -- The number of symbols in the NanoId String. Must be greater than 0.
    ...
    additionalBytesFactor float DEFAULT 1.75 -- The additional bytes factor used for calculating the step size. Must be equal or greater then 1.
)

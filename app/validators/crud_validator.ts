...
export const createUpdateBookValidation = vine.compile(
  vine.object({
    ...
    identifiers: vine.array(addIdValidator).maxLength(5).optional(),
    series: vine.array(addSeriesValidator).maxLength(5).optional(),
    tracks: vine.array(addIdValidator).maxLength(2047).optional(),
  })
)
